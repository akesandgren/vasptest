Feature: Basic tests
    ...
    Scenario: Fe-bcc
        ...
        Then the total energy should be -8.230787 +/- 1.0e-5 eV
        ...
        and the xx component of the stress tensor should be -41.31153 +/- 0.1 kB
        and the yy component of the stress tensor should be -41.31153 +/- 0.1 kB
        and the zz component of the stress tensor should be -41.31153 +/- 0.1 kB
    ...
    Scenario: Cu-fcc
        ...
        When I run VASP with a maximum of 8 ranks
        Then the total energy should be -3.747885 +/- 1.0e-5 eV
        and self consistency should be reached in 11 iterations
        and the Fermi energy should be 6.927426 +/- 0.01 eV
        and the pressure should be -65.13 +/- 0.1 kB
        and the xx component of the stress tensor should be -65.12799 +/- 0.1 kB
        and the yy component of the stress tensor should be -65.12805 +/- 0.1 kB
        and the zz component of the stress tensor should be -65.12805 +/- 0.1 kB
        and the xy component of the stress tensor should be 0.0 +/- 0.01 kB
        and the point group symmetry should be O_h
        and the XML output should be valid
